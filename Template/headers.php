...
<nav class="navbar navbar-expand-lg bg-light fixed-top " >
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="img/TRUE_LOGO (1).png" width="175" alt="Hardware place"></a>
        ...
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" >
              ...
              <li><a class="dropdown-item" href="#">Carte Mére</a></li>
              <li><a class="dropdown-item" href="#">Memoire</a></li>
              <li><a class="dropdown-item" href="#">SSD</a></li>
              <li><a class="dropdown-item" href="#">Boitier</a></li>
              <li><a class="dropdown-item" href="#">Ventilateur</a></li>
              <li><a class="dropdown-item" href="#">Boite d'alimentations</a></li>
            </ul>
          </li>
        </ul>
